...
// IDENTITY
    ...
    $('#open-pedal-power-popup').magnificPopup({
    items: [
          {
            src: '../../images/identity/pedal-power-1.gif',
            title: 'Pedal Power Logo 1'
          },
                {
            src: '../../images/identity/pedal-power-2.gif',
            title: 'Pedal Power Logo 2'
          },
        ],
        gallery: {
          enabled: true
